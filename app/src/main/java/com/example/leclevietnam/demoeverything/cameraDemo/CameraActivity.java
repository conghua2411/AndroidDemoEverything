package com.example.leclevietnam.demoeverything.cameraDemo;
...
//            mBackgroundHandler.post()
            ...
            try {
                ...
                if (image != null) {
                    ...
                    Bitmap bitmap = fromByteBuffer(byteBuffer);
                }
            } catch (Exception e) {
                e.printStackTrace();
                Log.d("ImageReader", "onImageAvailable: " + e.getLocalizedMessage());
            }
        }
    };

    private Bitmap fromByteBuffer(ByteBuffer byteBuffer) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSurfaceView = findViewById(R.id.svCameraPreview);
...
//        mImageReader = ImageReader.newInstance(mSurfaceView.getWidth(), mSurfaceView.getHeight(), ImageFormat.YV12, 30);
    }
...
//            setupCameraOutput(300, 300);
    ...
    private void configureCamera() {
        ...
        //new
        setupCameraOutput(mSurfaceView.getWidth(), mSurfaceView.getHeight());
        sfl.add(mImageReader.getSurface()); // surface for viewfinder preview
