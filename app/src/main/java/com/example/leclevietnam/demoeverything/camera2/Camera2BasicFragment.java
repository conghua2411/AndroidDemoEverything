            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface, mImageReader.getSurface()),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession session) {
                            Log.d(TAG, "onConfigured: createCameraPreviewSession");
                        ...
                        public void onConfigureFailed(@NonNull CameraCaptureSession session) {
                            Log.d(TAG, "onConfigureFailed: createCameraPreviewSession");
                            showToast("Failed");
                        }
                    }, null
            );
...
//        baseAPI.init()
    ...
    private void takeTextureBitmap() {
        if (mTextureView.isAvailable()) {
            Bitmap bitmap = mTextureView.getBitmap(640, 480);

//            Bitmap bitmapCrop = Bitmap.createBitmap(bitmap, 150, 150, 400, 80);

//            Bitmap bitmap2 = Bitmap.createBitmap(320, 80, Bitmap.Config.ARGB_8888);
//
...
//            canvas.drawRect(30, 30, 100, 100, paint);
            ...
            Log.d(TAG, "takeTextureBitmap: asdasdasdasd");
            bitmap.recycle();
...
//            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile));
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback = new CameraCaptureSession.CaptureCallback() {
        ...
        public void onCaptureProgressed(@NonNull CameraCaptureSession session,
            ...
            Log.d(TAG, "onCaptureProgressed: mCaptureCallback");
//            process(partialResult);
        ...
        public void onCaptureCompleted(@NonNull CameraCaptureSession session,
            ...
            Log.d(TAG, "onCaptureCompleted: mCaptureCallback" + mState);
//            process(result);
        }
    };
            ...
            CameraCaptureSession.CaptureCallback captureCallback =
                    new CameraCaptureSession.CaptureCallback() {
                        ...
                        public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                                                       @NonNull CaptureRequest request,
                                                       @NonNull TotalCaptureResult result) {
                            Log.d(TAG, "onCaptureCompleted: captureStillPicture");
    ...
    private void setAutoFlash(CaptureRequest.Builder requestBuilder) {
        Log.d(TAG, "setAutoFlash: " + mFlashSupported);
        if (mFlashSupported) {
...
//                mFlashSupported = available == null ? false : available;
    ...
    public void onResume() {
        ...
        Log.d(TAG, "onResume: mTextureView : " + mTextureView.getWidth() + " -- " + mTextureView.getHeight());

        if (mTextureView.isAvailable()) {
            Log.d(TAG, "onResume: mTextureView - true");
            openCamera(mTextureView.getWidth(), mTextureView.getHeight());
        } else {
            Log.d(TAG, "onResume: mTextureView - false");
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        @Override
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            Log.d(TAG, "onCreateDialog: ConfirmationDialog");
